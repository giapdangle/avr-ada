...
#elsif MCU = "attiny2313" or else MCU = "atmega168" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then

...
-- #if MCU = "atmega32" or else MCU = "atmega168" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" then
   Ctrl_Reg       : Bits_In_Byte renames MCU.TCCR1A_Bits;
-- #end if;


-- #if MCU = "atmega32" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega168" or else MCU = "atmega644p" then
...
#if MCU = "atmega32" or else MCU = "atmega168" or else MCU = "atmega168a" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
...
#if MCU = "attiny13" or else MCU = "atmega32" or else MCU = "atmega168" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
...
--     Com1 : Boolean renames Ctrl_Reg (MCU.COM11_Bit);
   ...
   is
   begin
-- #if MCU = "attiny13" or else MCU = "atmega32" or else MCU = "atmega168" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644p" then

...
package body AVR.Timer2 is
...
#if MCU = "atmega168" or else MCU = "atmega168p" or else MCU = "atmega168pa" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
...
#if MCU = "attiny13" or else MCU = "atmega168" or else MCU = "atmega168p" or else MCU = "atmega168pa" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
...
#if MCU = "atmega168" or else MCU = "atmega168p" or else MCU = "atmega168pa" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
...
#if MCU = "attiny13" or else MCU = "atmega168" or else MCU = "atmega168p" or else MCU = "atmega168pa" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega2560" then
   ...
   begin
      ...
      --  set the control register with the prescaler and mode flags to
      --  timer output compare mode and clear timer on compare match
#if MCU = "atmega168" or else MCU = "atmega168p" or else MCU = "atmega168pa" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega2560" then
      Ctrl_Reg := (MCU.COM2A0_Bit => False, --  \  normal operation,
                   MCU.COM2A1_Bit => False, --  /  OC0 disconnected
...
#if MCU = "atmega168" or else MCU = "atmega169" or else MCU = "atmega328p" or else MCU = "atmega328" or else MCU = "atmega644" or else MCU = "atmega644p" or else MCU = "atmega2560" then
